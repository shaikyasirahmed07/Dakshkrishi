...
public class UserController {
    ...
    public String getUserByNamePass(
        ...
        try {
            ...
            session.setAttribute("loggedInUser", authenticatedUser);  // Save the authenticated user in session

            // Redirect to the home page which includes the header after login
            return "redirect:/users/home";  // After successful login, redirect to home page
    ...
    public String homePage(HttpSession session, Model model) {
        ...
        model.addAttribute("username", loggedInUser.getName());  // Pass username to the model
        logger.info("Logged in user: {}", loggedInUser.getName());
